...
class DinoStructureLoss:
    def __init__(self, ):
        ...
        self.preprocess_a = torchvision.transforms.Compose([
            torchvision.transforms.Resize(224),
            torchvision.transforms.ToTensor(),
            torchvision.transforms.Normalize((0.601, 0.327, 0.252), (0.261, 0.191, 0.151))
        ])
        self.preprocess_b = torchvision.transforms.Compose([
            torchvision.transforms.Resize(224),
            torchvision.transforms.ToTensor(),
            torchvision.transforms.Normalize((0.445, 0.392, 0.339), (0.261, 0.228, 0.203))
        ])
